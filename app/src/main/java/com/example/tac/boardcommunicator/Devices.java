...
public class Devices extends AppCompatActivity implements
    ...
    public void disconnectFromBT(View view){
       ...
       /* Log.d(TAG, "disconnectFromBT: pressed disconnect");
        ConnectedThread temp = new ConnectedThread();
        temp.run();
        byte[] by_original = {0,1,-2,3,-4,-5,6};
        temp.write("test".getBytes());*/
    }
...
/*        public byte[] read(){
            ...
            try{
                ...
                result_text.setText(e.getMessage());
                return null;
            }
        }*/
        ...
        public void run() {
            ...
            while (true) {
                ...
                try {
                    ...
                    //Log.d(TAG, "run: " + b);
                    //s = new String(mmBuffer, "ASCII");
                    //Log.d(TAG, "run: " + s);
                    Log.d(TAG, "run: before new code");
