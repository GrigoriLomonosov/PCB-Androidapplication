...
/*
    ...
    public BTCommunicator(Activity activity) {
    ...
    public void enableBT() {
        if (!bluetoothAdapter.isEnabled()) {
            Intent enableBtIntent = new Intent(activity, BluetoothAdapter.ACTION_REQUEST_ENABLE);
    ...
    public BTCommunicator(Handler handler, BluetoothDevice device) {
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            synchronized (BTCommunicator.this) {
                connectThread = null;
            }
